...
from rpasdt.common.utils import get_function_default_kwargs
...
def find_communities(
    type: CommunityOptionEnum, graph: Graph, number_communities: int = 1, **alg_kwargs
) -> Dict[int, List[int]]:
    alg = getattr(algorithms, type.value)
