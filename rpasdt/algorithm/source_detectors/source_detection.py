...
from rpasdt.algorithm.source_detectors.centrality import \
    ...
    UnbiasedCentralityBasedSourceDetector, CentralityBasedSourceDetector
from rpasdt.algorithm.source_detectors.common import SourceDetector
from rpasdt.algorithm.source_detectors.dynamic_age import DynamicAgeSourceDetector
...
def get_source_detector(algorithm: SourceDetectionAlgorithm,
                        G: Graph, IG: Graph, number_of_sources=1, *args,
                        **kwargs) -> SourceDetector:
