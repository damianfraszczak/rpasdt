...
from PyQt5.QtWidgets import QTabWidget, QMdiSubWindow

from rpasdt.gui.mathplotlib_components import NetworkxGraphPanelWithToolbar, NetworkxGraphPanel
...
class AnalysisNetworkGraphPanel(NetworkxGraphPanel):
    ...
    def create_toolbar(self):
        return AnalysisNetworkGraphToolbar(
...
class BaseAnalysisDialog(QMdiSubWindow):
    ...
    def add_table(self, headers: List[str], data: List[List], title: str) -> Tuple[
        QtWidgets.QTableView, ListTableModel]:
...
class AnalysisDialog(BaseAnalysisDialog):
    ...
    def get_graph_panel(self):
        ...
        return self.graph_panel(controller=self.controller,
                                data=self.data)
    ...
    def configure_gui(self):
        ...
        self.add_table(headers=self.get_table_header(), data=self.get_table_data(), title="Data")
