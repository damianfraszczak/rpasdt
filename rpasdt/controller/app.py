...
from rpasdt.gui.utils import show_dynamic_dialog, show_alert_dialog, run_long_task
from rpasdt.model.experiment import Experiment
from rpasdt.network.networkx_utils import get_graph_default_properties, \
...
class AppController:
    ...
    def load_experiment(self, experiment: Experiment, graph: Graph):
        ...
        self.window.show_experiment_window(experiment=experiment,
    ...
    def handler_about_dialog(self):
        show_alert_dialog(title='Author information',
                          text='Damian Frąszczak Military University of Technology')

    def handler_new_experiment(self):
        experiment = show_dynamic_dialog(object=Experiment(),
