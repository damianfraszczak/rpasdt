...
from rpasdt.gui.analysis.models import CommunityAnalysisData, AnalysisData
from rpasdt.gui.toolbar.toolbar_items import COMMUNITY_OPTIONS, CENTRALITY_OPTIONS
...
class AnalysisGraphController(GraphController):
    ...
    def __init__(self, window: 'MainWindow', graph: Graph, graph_config: GraphConfig, data: Dict):
...
class CommunityAnalysisControllerMixin:
    ...
    def show_community_result(self, data, title):
        self.show_dialog(AnalysisDialog(
